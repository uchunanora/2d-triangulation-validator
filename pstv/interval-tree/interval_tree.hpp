...
private:
        ...
        void set_segment(std::vector<std::vector<double>> const& seg)
        {
            segment_ = seg;
        }
    ...
    private:
        ...
        node* right_;
        rb_color color_;
        std::vector<std::vector<double>> segment_;
    };
//############################################################################################################
...
//############################################################################################################
    ...
    public:
        ...
        iterator insert(IntervalType&& ival, std::vector<std::vector<double>>&& seg)
        {
